...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for actionInvoice operation.
    /// </summary>
    public partial class ActionInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ActionInvoiceHeaders class.
        /// </summary>
        public ActionInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public ActionInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
