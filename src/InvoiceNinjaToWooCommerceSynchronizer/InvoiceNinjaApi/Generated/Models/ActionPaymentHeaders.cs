...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for actionPayment operation.
    /// </summary>
    public partial class ActionPaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ActionPaymentHeaders class.
        /// </summary>
        public ActionPaymentHeaders()
        {
            CustomInit();
        }
        ...
        public ActionPaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
