...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for actionQuote operation.
    /// </summary>
    public partial class ActionQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ActionQuoteHeaders class.
        /// </summary>
        public ActionQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public ActionQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
