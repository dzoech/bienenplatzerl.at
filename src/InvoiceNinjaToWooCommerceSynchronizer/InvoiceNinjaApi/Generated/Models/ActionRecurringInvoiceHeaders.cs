...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for actionRecurringInvoice operation.
    /// </summary>
    public partial class ActionRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ActionRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public ActionRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public ActionRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
