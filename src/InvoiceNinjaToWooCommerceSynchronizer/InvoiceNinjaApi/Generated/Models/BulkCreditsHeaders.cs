...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkCredits operation.
    /// </summary>
    public partial class BulkCreditsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkCreditsHeaders class.
        /// </summary>
        public BulkCreditsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkCreditsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
