...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkDesigns operation.
    /// </summary>
    public partial class BulkDesignsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkDesignsHeaders class.
        /// </summary>
        public BulkDesignsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkDesignsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
