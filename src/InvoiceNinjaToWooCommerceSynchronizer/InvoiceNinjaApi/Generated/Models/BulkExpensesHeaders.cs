...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkExpenses operation.
    /// </summary>
    public partial class BulkExpensesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkExpensesHeaders class.
        /// </summary>
        public BulkExpensesHeaders()
        {
            CustomInit();
        }
        ...
        public BulkExpensesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
