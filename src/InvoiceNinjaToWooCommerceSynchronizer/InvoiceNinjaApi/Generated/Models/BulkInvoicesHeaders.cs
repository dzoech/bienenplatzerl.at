...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkInvoices operation.
    /// </summary>
    public partial class BulkInvoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkInvoicesHeaders class.
        /// </summary>
        public BulkInvoicesHeaders()
        {
            CustomInit();
        }
        ...
        public BulkInvoicesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
