...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkRecurringInvoices operation.
    /// </summary>
    public partial class BulkRecurringInvoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkRecurringInvoicesHeaders
        /// class.
        /// </summary>
        public BulkRecurringInvoicesHeaders()
        {
            CustomInit();
        }
        ...
        public BulkRecurringInvoicesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
