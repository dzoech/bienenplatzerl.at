...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkTokens operation.
    /// </summary>
    public partial class BulkTokensHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkTokensHeaders class.
        /// </summary>
        public BulkTokensHeaders()
        {
            CustomInit();
        }
        ...
        public BulkTokensHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
