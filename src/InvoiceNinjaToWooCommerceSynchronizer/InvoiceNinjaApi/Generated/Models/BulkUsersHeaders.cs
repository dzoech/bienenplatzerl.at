...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkUsers operation.
    /// </summary>
    public partial class BulkUsersHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkUsersHeaders class.
        /// </summary>
        public BulkUsersHeaders()
        {
            CustomInit();
        }
        ...
        public BulkUsersHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
