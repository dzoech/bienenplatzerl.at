...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkVendors operation.
    /// </summary>
    public partial class BulkVendorsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkVendorsHeaders class.
        /// </summary>
        public BulkVendorsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkVendorsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
