...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteClient operation.
    /// </summary>
    public partial class DeleteClientHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteClientHeaders class.
        /// </summary>
        public DeleteClientHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteClientHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
