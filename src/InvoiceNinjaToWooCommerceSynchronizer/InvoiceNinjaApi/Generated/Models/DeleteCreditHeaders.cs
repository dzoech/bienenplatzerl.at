...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteCredit operation.
    /// </summary>
    public partial class DeleteCreditHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteCreditHeaders class.
        /// </summary>
        public DeleteCreditHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteCreditHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
