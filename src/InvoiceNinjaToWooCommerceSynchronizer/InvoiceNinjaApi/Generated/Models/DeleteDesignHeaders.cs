...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteDesign operation.
    /// </summary>
    public partial class DeleteDesignHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteDesignHeaders class.
        /// </summary>
        public DeleteDesignHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteDesignHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
