...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteGroupSetting operation.
    /// </summary>
    public partial class DeleteGroupSettingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteGroupSettingHeaders class.
        /// </summary>
        public DeleteGroupSettingHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteGroupSettingHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
