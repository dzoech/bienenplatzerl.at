...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteProduct operation.
    /// </summary>
    public partial class DeleteProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteProductHeaders class.
        /// </summary>
        public DeleteProductHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteProductHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
