...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteRecurringQuote operation.
    /// </summary>
    public partial class DeleteRecurringQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteRecurringQuoteHeaders
        /// class.
        /// </summary>
        public DeleteRecurringQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteRecurringQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
