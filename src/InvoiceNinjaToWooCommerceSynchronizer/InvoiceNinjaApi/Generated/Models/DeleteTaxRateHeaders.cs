...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteTaxRate operation.
    /// </summary>
    public partial class DeleteTaxRateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteTaxRateHeaders class.
        /// </summary>
        public DeleteTaxRateHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteTaxRateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
