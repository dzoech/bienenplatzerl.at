...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteToken operation.
    /// </summary>
    public partial class DeleteTokenHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteTokenHeaders class.
        /// </summary>
        public DeleteTokenHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteTokenHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
