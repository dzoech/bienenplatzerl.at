...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class DeleteUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteUserHeaders class.
        /// </summary>
        public DeleteUserHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
