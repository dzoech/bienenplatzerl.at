...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for detachUser operation.
    /// </summary>
    public partial class DetachUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DetachUserHeaders class.
        /// </summary>
        public DetachUserHeaders()
        {
            CustomInit();
        }
        ...
        public DetachUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
