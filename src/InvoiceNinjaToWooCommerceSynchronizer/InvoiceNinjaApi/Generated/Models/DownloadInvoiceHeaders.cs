...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class DownloadInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DownloadInvoiceHeaders class.
        /// </summary>
        public DownloadInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public DownloadInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
