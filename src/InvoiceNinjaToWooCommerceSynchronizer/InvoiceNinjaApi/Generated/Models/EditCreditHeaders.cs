...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editCredit operation.
    /// </summary>
    public partial class EditCreditHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditCreditHeaders class.
        /// </summary>
        public EditCreditHeaders()
        {
            CustomInit();
        }
        ...
        public EditCreditHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
