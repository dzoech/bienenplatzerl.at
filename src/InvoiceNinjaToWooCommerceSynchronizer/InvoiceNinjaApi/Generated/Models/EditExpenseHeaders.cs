...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editExpense operation.
    /// </summary>
    public partial class EditExpenseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditExpenseHeaders class.
        /// </summary>
        public EditExpenseHeaders()
        {
            CustomInit();
        }
        ...
        public EditExpenseHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
