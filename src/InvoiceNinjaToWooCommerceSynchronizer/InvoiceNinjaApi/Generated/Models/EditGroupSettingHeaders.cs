...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editGroupSetting operation.
    /// </summary>
    public partial class EditGroupSettingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditGroupSettingHeaders class.
        /// </summary>
        public EditGroupSettingHeaders()
        {
            CustomInit();
        }
        ...
        public EditGroupSettingHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
