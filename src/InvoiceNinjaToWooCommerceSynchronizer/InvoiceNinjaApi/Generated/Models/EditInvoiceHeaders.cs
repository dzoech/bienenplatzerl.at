...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editInvoice operation.
    /// </summary>
    public partial class EditInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditInvoiceHeaders class.
        /// </summary>
        public EditInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public EditInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
