...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editPayment operation.
    /// </summary>
    public partial class EditPaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditPaymentHeaders class.
        /// </summary>
        public EditPaymentHeaders()
        {
            CustomInit();
        }
        ...
        public EditPaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
