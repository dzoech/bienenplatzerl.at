...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editQuote operation.
    /// </summary>
    public partial class EditQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditQuoteHeaders class.
        /// </summary>
        public EditQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public EditQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
