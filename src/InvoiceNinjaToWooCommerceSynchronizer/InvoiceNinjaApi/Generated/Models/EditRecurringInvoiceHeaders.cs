...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editRecurringInvoice operation.
    /// </summary>
    public partial class EditRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public EditRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public EditRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
