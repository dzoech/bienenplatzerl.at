...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editRecurringQuote operation.
    /// </summary>
    public partial class EditRecurringQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditRecurringQuoteHeaders class.
        /// </summary>
        public EditRecurringQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public EditRecurringQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
