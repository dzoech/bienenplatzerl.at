...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editSubscription operation.
    /// </summary>
    public partial class EditSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditSubscriptionHeaders class.
        /// </summary>
        public EditSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public EditSubscriptionHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
