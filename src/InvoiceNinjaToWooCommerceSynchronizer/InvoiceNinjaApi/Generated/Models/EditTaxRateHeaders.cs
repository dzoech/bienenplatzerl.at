...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editTaxRate operation.
    /// </summary>
    public partial class EditTaxRateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditTaxRateHeaders class.
        /// </summary>
        public EditTaxRateHeaders()
        {
            CustomInit();
        }
        ...
        public EditTaxRateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
