...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editToken operation.
    /// </summary>
    public partial class EditTokenHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditTokenHeaders class.
        /// </summary>
        public EditTokenHeaders()
        {
            CustomInit();
        }
        ...
        public EditTokenHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
