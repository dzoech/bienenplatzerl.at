...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editUser operation.
    /// </summary>
    public partial class EditUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditUserHeaders class.
        /// </summary>
        public EditUserHeaders()
        {
            CustomInit();
        }
        ...
        public EditUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
