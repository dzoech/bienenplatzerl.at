...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editVendor operation.
    /// </summary>
    public partial class EditVendorHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditVendorHeaders class.
        /// </summary>
        public EditVendorHeaders()
        {
            CustomInit();
        }
        ...
        public EditVendorHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
