...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getActivities operation.
    /// </summary>
    public partial class GetActivitiesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetActivitiesHeaders class.
        /// </summary>
        public GetActivitiesHeaders()
        {
            CustomInit();
        }
        ...
        public GetActivitiesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
