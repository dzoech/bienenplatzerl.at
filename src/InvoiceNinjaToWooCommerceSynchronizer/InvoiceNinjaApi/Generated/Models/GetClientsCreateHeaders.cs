...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getClientsCreate operation.
    /// </summary>
    public partial class GetClientsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetClientsCreateHeaders class.
        /// </summary>
        public GetClientsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetClientsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
