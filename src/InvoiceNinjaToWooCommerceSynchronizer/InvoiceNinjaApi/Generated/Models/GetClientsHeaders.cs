...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getClients operation.
    /// </summary>
    public partial class GetClientsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetClientsHeaders class.
        /// </summary>
        public GetClientsHeaders()
        {
            CustomInit();
        }
        ...
        public GetClientsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
