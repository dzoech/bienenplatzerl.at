...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCompaniesCreate operation.
    /// </summary>
    public partial class GetCompaniesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCompaniesCreateHeaders class.
        /// </summary>
        public GetCompaniesCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetCompaniesCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
