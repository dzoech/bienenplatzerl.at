...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCompanyGatewaysCreate operation.
    /// </summary>
    public partial class GetCompanyGatewaysCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCompanyGatewaysCreateHeaders
        /// class.
        /// </summary>
        public GetCompanyGatewaysCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetCompanyGatewaysCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
