...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCompanyGateways operation.
    /// </summary>
    public partial class GetCompanyGatewaysHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCompanyGatewaysHeaders class.
        /// </summary>
        public GetCompanyGatewaysHeaders()
        {
            CustomInit();
        }
        ...
        public GetCompanyGatewaysHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
