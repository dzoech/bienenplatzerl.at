...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCredits operation.
    /// </summary>
    public partial class GetCreditsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCreditsHeaders class.
        /// </summary>
        public GetCreditsHeaders()
        {
            CustomInit();
        }
        ...
        public GetCreditsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
