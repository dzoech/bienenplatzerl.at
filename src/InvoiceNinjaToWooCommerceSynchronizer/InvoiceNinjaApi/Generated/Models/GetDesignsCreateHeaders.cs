...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getDesignsCreate operation.
    /// </summary>
    public partial class GetDesignsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDesignsCreateHeaders class.
        /// </summary>
        public GetDesignsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetDesignsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
