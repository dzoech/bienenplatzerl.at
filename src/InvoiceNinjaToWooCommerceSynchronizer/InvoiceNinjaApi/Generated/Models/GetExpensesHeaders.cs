...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getExpenses operation.
    /// </summary>
    public partial class GetExpensesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetExpensesHeaders class.
        /// </summary>
        public GetExpensesHeaders()
        {
            CustomInit();
        }
        ...
        public GetExpensesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
