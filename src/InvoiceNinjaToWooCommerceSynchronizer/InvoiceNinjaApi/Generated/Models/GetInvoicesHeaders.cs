...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getInvoices operation.
    /// </summary>
    public partial class GetInvoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetInvoicesHeaders class.
        /// </summary>
        public GetInvoicesHeaders()
        {
            CustomInit();
        }
        ...
        public GetInvoicesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
