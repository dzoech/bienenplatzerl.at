...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getPayments operation.
    /// </summary>
    public partial class GetPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetPaymentsHeaders class.
        /// </summary>
        public GetPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public GetPaymentsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
