...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class GetPreviewHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetPreviewHeaders class.
        /// </summary>
        public GetPreviewHeaders()
        {
            CustomInit();
        }
        ...
        public GetPreviewHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
