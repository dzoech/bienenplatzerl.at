...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getProductsCreate operation.
    /// </summary>
    public partial class GetProductsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetProductsCreateHeaders class.
        /// </summary>
        public GetProductsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetProductsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
