...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getProducts operation.
    /// </summary>
    public partial class GetProductsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetProductsHeaders class.
        /// </summary>
        public GetProductsHeaders()
        {
            CustomInit();
        }
        ...
        public GetProductsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
