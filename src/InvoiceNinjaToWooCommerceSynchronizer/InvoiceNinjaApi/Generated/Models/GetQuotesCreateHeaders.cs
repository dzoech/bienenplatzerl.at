...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getQuotesCreate operation.
    /// </summary>
    public partial class GetQuotesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetQuotesCreateHeaders class.
        /// </summary>
        public GetQuotesCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetQuotesCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
