...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getRecurringInvoicesCreate operation.
    /// </summary>
    public partial class GetRecurringInvoicesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetRecurringInvoicesCreateHeaders
        /// class.
        /// </summary>
        public GetRecurringInvoicesCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetRecurringInvoicesCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
