...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getTaxRateCreate operation.
    /// </summary>
    public partial class GetTaxRateCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTaxRateCreateHeaders class.
        /// </summary>
        public GetTaxRateCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetTaxRateCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
