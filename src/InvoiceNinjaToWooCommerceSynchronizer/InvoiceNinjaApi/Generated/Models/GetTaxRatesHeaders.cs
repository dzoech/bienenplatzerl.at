...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getTaxRates operation.
    /// </summary>
    public partial class GetTaxRatesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTaxRatesHeaders class.
        /// </summary>
        public GetTaxRatesHeaders()
        {
            CustomInit();
        }
        ...
        public GetTaxRatesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
