...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getTokensCreate operation.
    /// </summary>
    public partial class GetTokensCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTokensCreateHeaders class.
        /// </summary>
        public GetTokensCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetTokensCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
