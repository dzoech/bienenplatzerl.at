...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getTokens operation.
    /// </summary>
    public partial class GetTokensHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetTokensHeaders class.
        /// </summary>
        public GetTokensHeaders()
        {
            CustomInit();
        }
        ...
        public GetTokensHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
