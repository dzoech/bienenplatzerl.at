...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for postLogin operation.
    /// </summary>
    public partial class PostLoginHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostLoginHeaders class.
        /// </summary>
        public PostLoginHeaders()
        {
            CustomInit();
        }
        ...
        public PostLoginHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
