...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for postSignup operation.
    /// </summary>
    public partial class PostSignupHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostSignupHeaders class.
        /// </summary>
        public PostSignupHeaders()
        {
            CustomInit();
        }
        ...
        public PostSignupHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
