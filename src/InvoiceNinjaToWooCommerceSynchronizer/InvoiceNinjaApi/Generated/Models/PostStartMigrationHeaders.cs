...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for postStartMigration operation.
    /// </summary>
    public partial class PostStartMigrationHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostStartMigrationHeaders class.
        /// </summary>
        public PostStartMigrationHeaders()
        {
            CustomInit();
        }
        ...
        public PostStartMigrationHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
