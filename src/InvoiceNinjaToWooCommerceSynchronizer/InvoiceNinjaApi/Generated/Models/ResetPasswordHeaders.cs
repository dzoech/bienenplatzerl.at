...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for password operation.
    /// </summary>
    public partial class ResetPasswordHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ResetPasswordHeaders class.
        /// </summary>
        public ResetPasswordHeaders()
        {
            CustomInit();
        }
        ...
        public ResetPasswordHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
