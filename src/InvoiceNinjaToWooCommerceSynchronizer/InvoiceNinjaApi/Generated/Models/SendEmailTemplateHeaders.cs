...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for sendEmailTemplate operation.
    /// </summary>
    public partial class SendEmailTemplateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SendEmailTemplateHeaders class.
        /// </summary>
        public SendEmailTemplateHeaders()
        {
            CustomInit();
        }
        ...
        public SendEmailTemplateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
