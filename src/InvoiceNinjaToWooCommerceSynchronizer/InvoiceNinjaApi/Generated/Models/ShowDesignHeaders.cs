...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showDesign operation.
    /// </summary>
    public partial class ShowDesignHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowDesignHeaders class.
        /// </summary>
        public ShowDesignHeaders()
        {
            CustomInit();
        }
        ...
        public ShowDesignHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
