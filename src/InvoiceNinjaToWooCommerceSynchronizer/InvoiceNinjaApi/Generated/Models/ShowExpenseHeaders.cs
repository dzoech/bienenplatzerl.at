...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showExpense operation.
    /// </summary>
    public partial class ShowExpenseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowExpenseHeaders class.
        /// </summary>
        public ShowExpenseHeaders()
        {
            CustomInit();
        }
        ...
        public ShowExpenseHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
