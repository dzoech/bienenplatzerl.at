...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showInvoice operation.
    /// </summary>
    public partial class ShowInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowInvoiceHeaders class.
        /// </summary>
        public ShowInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public ShowInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
