...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showPayment operation.
    /// </summary>
    public partial class ShowPaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowPaymentHeaders class.
        /// </summary>
        public ShowPaymentHeaders()
        {
            CustomInit();
        }
        ...
        public ShowPaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
