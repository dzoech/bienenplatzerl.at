...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showProduct operation.
    /// </summary>
    public partial class ShowProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowProductHeaders class.
        /// </summary>
        public ShowProductHeaders()
        {
            CustomInit();
        }
        ...
        public ShowProductHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
