...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showQuote operation.
    /// </summary>
    public partial class ShowQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowQuoteHeaders class.
        /// </summary>
        public ShowQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public ShowQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
