...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showToken operation.
    /// </summary>
    public partial class ShowTokenHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowTokenHeaders class.
        /// </summary>
        public ShowTokenHeaders()
        {
            CustomInit();
        }
        ...
        public ShowTokenHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
