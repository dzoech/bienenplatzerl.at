...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showUser operation.
    /// </summary>
    public partial class ShowUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowUserHeaders class.
        /// </summary>
        public ShowUserHeaders()
        {
            CustomInit();
        }
        ...
        public ShowUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
