...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeCompanyGateway operation.
    /// </summary>
    public partial class StoreCompanyGatewayHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreCompanyGatewayHeaders class.
        /// </summary>
        public StoreCompanyGatewayHeaders()
        {
            CustomInit();
        }
        ...
        public StoreCompanyGatewayHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
