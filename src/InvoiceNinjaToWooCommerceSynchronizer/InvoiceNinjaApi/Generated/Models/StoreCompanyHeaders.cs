...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeCompany operation.
    /// </summary>
    public partial class StoreCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreCompanyHeaders class.
        /// </summary>
        public StoreCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public StoreCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
