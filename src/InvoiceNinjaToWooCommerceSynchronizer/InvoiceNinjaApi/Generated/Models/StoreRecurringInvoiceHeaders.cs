...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeRecurringInvoice operation.
    /// </summary>
    public partial class StoreRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public StoreRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public StoreRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
