...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeRecurringQuote operation.
    /// </summary>
    public partial class StoreRecurringQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreRecurringQuoteHeaders class.
        /// </summary>
        public StoreRecurringQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public StoreRecurringQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
