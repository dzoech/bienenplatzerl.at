...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeSubscription operation.
    /// </summary>
    public partial class StoreSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreSubscriptionHeaders class.
        /// </summary>
        public StoreSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public StoreSubscriptionHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
