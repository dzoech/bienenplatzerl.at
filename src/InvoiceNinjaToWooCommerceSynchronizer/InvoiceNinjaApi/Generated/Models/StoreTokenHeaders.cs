...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeToken operation.
    /// </summary>
    public partial class StoreTokenHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreTokenHeaders class.
        /// </summary>
        public StoreTokenHeaders()
        {
            CustomInit();
        }
        ...
        public StoreTokenHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
