...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeUser operation.
    /// </summary>
    public partial class StoreUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreUserHeaders class.
        /// </summary>
        public StoreUserHeaders()
        {
            CustomInit();
        }
        ...
        public StoreUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
