...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeVendor operation.
    /// </summary>
    public partial class StoreVendorHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreVendorHeaders class.
        /// </summary>
        public StoreVendorHeaders()
        {
            CustomInit();
        }
        ...
        public StoreVendorHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
