...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for supportMessage operation.
    /// </summary>
    public partial class SupportMessageHeaders
    {
        /// <summary>
        /// Initializes a new instance of the SupportMessageHeaders class.
        /// </summary>
        public SupportMessageHeaders()
        {
            CustomInit();
        }
        ...
        public SupportMessageHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
