...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateCompanyGateway operation.
    /// </summary>
    public partial class UpdateCompanyGatewayHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateCompanyGatewayHeaders
        /// class.
        /// </summary>
        public UpdateCompanyGatewayHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateCompanyGatewayHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
