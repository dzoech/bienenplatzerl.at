...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateGroupSetting operation.
    /// </summary>
    public partial class UpdateGroupSettingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateGroupSettingHeaders class.
        /// </summary>
        public UpdateGroupSettingHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateGroupSettingHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
