...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updatePayment operation.
    /// </summary>
    public partial class UpdatePaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdatePaymentHeaders class.
        /// </summary>
        public UpdatePaymentHeaders()
        {
            CustomInit();
        }
        ...
        public UpdatePaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
