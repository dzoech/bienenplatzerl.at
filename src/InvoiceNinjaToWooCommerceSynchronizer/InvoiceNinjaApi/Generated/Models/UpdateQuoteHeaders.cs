...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateQuote operation.
    /// </summary>
    public partial class UpdateQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateQuoteHeaders class.
        /// </summary>
        public UpdateQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
