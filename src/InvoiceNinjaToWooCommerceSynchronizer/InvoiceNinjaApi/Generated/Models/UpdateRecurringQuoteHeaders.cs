...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateRecurringQuote operation.
    /// </summary>
    public partial class UpdateRecurringQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateRecurringQuoteHeaders
        /// class.
        /// </summary>
        public UpdateRecurringQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateRecurringQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
