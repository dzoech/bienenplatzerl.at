...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class UpdateSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateSubscriptionHeaders class.
        /// </summary>
        public UpdateSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateSubscriptionHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
