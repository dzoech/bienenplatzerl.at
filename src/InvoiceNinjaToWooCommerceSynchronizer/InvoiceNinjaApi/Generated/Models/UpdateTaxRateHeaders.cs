...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateTaxRate operation.
    /// </summary>
    public partial class UpdateTaxRateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateTaxRateHeaders class.
        /// </summary>
        public UpdateTaxRateHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateTaxRateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
