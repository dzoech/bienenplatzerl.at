...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class UpdateUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateUserHeaders class.
        /// </summary>
        public UpdateUserHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
