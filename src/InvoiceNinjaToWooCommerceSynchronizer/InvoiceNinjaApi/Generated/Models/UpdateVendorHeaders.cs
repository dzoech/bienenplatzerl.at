...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateVendor operation.
    /// </summary>
    public partial class UpdateVendorHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateVendorHeaders class.
        /// </summary>
        public UpdateVendorHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateVendorHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
