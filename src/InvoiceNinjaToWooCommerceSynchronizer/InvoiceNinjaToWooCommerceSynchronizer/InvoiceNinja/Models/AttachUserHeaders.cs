...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for attachUser operation.
    /// </summary>
    public partial class AttachUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the AttachUserHeaders class.
        /// </summary>
        public AttachUserHeaders()
        {
            CustomInit();
        }
        ...
        public AttachUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
