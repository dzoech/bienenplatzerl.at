...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkClients operation.
    /// </summary>
    public partial class BulkClientsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkClientsHeaders class.
        /// </summary>
        public BulkClientsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkClientsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
