...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkPayments operation.
    /// </summary>
    public partial class BulkPaymentsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkPaymentsHeaders class.
        /// </summary>
        public BulkPaymentsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkPaymentsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
