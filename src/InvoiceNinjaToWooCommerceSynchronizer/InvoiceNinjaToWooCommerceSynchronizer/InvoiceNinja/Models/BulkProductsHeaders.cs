...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkProducts operation.
    /// </summary>
    public partial class BulkProductsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkProductsHeaders class.
        /// </summary>
        public BulkProductsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkProductsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
