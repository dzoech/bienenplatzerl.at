...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkQuotes operation.
    /// </summary>
    public partial class BulkQuotesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkQuotesHeaders class.
        /// </summary>
        public BulkQuotesHeaders()
        {
            CustomInit();
        }
        ...
        public BulkQuotesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
