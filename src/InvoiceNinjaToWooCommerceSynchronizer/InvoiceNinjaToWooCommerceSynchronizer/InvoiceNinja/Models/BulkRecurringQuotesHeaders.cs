...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkRecurringQuotes operation.
    /// </summary>
    public partial class BulkRecurringQuotesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkRecurringQuotesHeaders class.
        /// </summary>
        public BulkRecurringQuotesHeaders()
        {
            CustomInit();
        }
        ...
        public BulkRecurringQuotesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
