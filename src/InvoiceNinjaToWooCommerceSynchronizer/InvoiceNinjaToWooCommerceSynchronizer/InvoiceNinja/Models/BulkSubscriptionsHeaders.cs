...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for bulkSubscriptions operation.
    /// </summary>
    public partial class BulkSubscriptionsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the BulkSubscriptionsHeaders class.
        /// </summary>
        public BulkSubscriptionsHeaders()
        {
            CustomInit();
        }
        ...
        public BulkSubscriptionsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
