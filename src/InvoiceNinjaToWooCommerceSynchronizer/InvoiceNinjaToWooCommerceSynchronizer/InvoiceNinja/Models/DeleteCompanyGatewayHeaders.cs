...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteCompanyGateway operation.
    /// </summary>
    public partial class DeleteCompanyGatewayHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteCompanyGatewayHeaders
        /// class.
        /// </summary>
        public DeleteCompanyGatewayHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteCompanyGatewayHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
