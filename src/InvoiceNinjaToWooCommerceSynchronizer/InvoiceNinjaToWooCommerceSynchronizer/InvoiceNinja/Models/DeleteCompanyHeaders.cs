...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteCompany operation.
    /// </summary>
    public partial class DeleteCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteCompanyHeaders class.
        /// </summary>
        public DeleteCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
