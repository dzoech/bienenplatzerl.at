...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteExpense operation.
    /// </summary>
    public partial class DeleteExpenseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteExpenseHeaders class.
        /// </summary>
        public DeleteExpenseHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteExpenseHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
