...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteInvoice operation.
    /// </summary>
    public partial class DeleteInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteInvoiceHeaders class.
        /// </summary>
        public DeleteInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
