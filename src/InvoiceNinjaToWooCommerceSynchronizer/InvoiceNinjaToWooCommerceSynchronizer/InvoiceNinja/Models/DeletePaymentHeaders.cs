...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deletePayment operation.
    /// </summary>
    public partial class DeletePaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeletePaymentHeaders class.
        /// </summary>
        public DeletePaymentHeaders()
        {
            CustomInit();
        }
        ...
        public DeletePaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
