...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteQuote operation.
    /// </summary>
    public partial class DeleteQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteQuoteHeaders class.
        /// </summary>
        public DeleteQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
