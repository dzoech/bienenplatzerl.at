...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteRecurringInvoice operation.
    /// </summary>
    public partial class DeleteRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public DeleteRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
