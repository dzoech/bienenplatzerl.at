...
namespace InvoiceNinjaClient.Models
{
    ...
    /// </summary>
    public partial class DeleteSubscriptionHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteSubscriptionHeaders class.
        /// </summary>
        public DeleteSubscriptionHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteSubscriptionHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
