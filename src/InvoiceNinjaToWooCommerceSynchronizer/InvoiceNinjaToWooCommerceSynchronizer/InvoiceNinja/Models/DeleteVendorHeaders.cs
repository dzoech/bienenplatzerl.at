...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for deleteVendor operation.
    /// </summary>
    public partial class DeleteVendorHeaders
    {
        /// <summary>
        /// Initializes a new instance of the DeleteVendorHeaders class.
        /// </summary>
        public DeleteVendorHeaders()
        {
            CustomInit();
        }
        ...
        public DeleteVendorHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
