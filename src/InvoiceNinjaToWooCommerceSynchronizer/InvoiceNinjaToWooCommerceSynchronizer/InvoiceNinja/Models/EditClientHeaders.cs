...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editClient operation.
    /// </summary>
    public partial class EditClientHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditClientHeaders class.
        /// </summary>
        public EditClientHeaders()
        {
            CustomInit();
        }
        ...
        public EditClientHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
