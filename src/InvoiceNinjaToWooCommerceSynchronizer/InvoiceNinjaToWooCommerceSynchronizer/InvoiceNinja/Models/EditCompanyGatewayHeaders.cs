...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editCompanyGateway operation.
    /// </summary>
    public partial class EditCompanyGatewayHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditCompanyGatewayHeaders class.
        /// </summary>
        public EditCompanyGatewayHeaders()
        {
            CustomInit();
        }
        ...
        public EditCompanyGatewayHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
