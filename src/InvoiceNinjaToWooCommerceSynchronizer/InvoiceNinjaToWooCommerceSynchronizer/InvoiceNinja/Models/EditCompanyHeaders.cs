...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editCompany operation.
    /// </summary>
    public partial class EditCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditCompanyHeaders class.
        /// </summary>
        public EditCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public EditCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
