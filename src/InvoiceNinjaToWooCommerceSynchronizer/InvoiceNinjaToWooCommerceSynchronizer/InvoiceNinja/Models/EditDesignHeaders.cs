...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editDesign operation.
    /// </summary>
    public partial class EditDesignHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditDesignHeaders class.
        /// </summary>
        public EditDesignHeaders()
        {
            CustomInit();
        }
        ...
        public EditDesignHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
