...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for editProduct operation.
    /// </summary>
    public partial class EditProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the EditProductHeaders class.
        /// </summary>
        public EditProductHeaders()
        {
            CustomInit();
        }
        ...
        public EditProductHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
