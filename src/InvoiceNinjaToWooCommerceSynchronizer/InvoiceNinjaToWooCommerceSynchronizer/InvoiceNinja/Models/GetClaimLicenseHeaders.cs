...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getClaimLicense operation.
    /// </summary>
    public partial class GetClaimLicenseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetClaimLicenseHeaders class.
        /// </summary>
        public GetClaimLicenseHeaders()
        {
            CustomInit();
        }
        ...
        public GetClaimLicenseHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
