...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCompanies operation.
    /// </summary>
    public partial class GetCompaniesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCompaniesHeaders class.
        /// </summary>
        public GetCompaniesHeaders()
        {
            CustomInit();
        }
        ...
        public GetCompaniesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
