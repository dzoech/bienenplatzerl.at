...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCompanyLedger operation.
    /// </summary>
    public partial class GetCompanyLedgerHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCompanyLedgerHeaders class.
        /// </summary>
        public GetCompanyLedgerHeaders()
        {
            CustomInit();
        }
        ...
        public GetCompanyLedgerHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
