...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getCreditsCreate operation.
    /// </summary>
    public partial class GetCreditsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetCreditsCreateHeaders class.
        /// </summary>
        public GetCreditsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetCreditsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
