...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getDesigns operation.
    /// </summary>
    public partial class GetDesignsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetDesignsHeaders class.
        /// </summary>
        public GetDesignsHeaders()
        {
            CustomInit();
        }
        ...
        public GetDesignsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
