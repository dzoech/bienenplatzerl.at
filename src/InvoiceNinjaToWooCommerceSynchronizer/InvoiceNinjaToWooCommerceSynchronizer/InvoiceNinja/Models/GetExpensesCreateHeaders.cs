...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getExpensesCreate operation.
    /// </summary>
    public partial class GetExpensesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetExpensesCreateHeaders class.
        /// </summary>
        public GetExpensesCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetExpensesCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
