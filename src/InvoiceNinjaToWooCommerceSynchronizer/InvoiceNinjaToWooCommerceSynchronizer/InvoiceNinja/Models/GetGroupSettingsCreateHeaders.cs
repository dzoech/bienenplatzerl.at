...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getGroupSettingsCreate operation.
    /// </summary>
    public partial class GetGroupSettingsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetGroupSettingsCreateHeaders
        /// class.
        /// </summary>
        public GetGroupSettingsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetGroupSettingsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
