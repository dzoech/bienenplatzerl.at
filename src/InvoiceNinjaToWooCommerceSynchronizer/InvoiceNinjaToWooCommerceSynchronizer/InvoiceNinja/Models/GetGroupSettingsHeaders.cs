...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getGroupSettings operation.
    /// </summary>
    public partial class GetGroupSettingsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetGroupSettingsHeaders class.
        /// </summary>
        public GetGroupSettingsHeaders()
        {
            CustomInit();
        }
        ...
        public GetGroupSettingsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
