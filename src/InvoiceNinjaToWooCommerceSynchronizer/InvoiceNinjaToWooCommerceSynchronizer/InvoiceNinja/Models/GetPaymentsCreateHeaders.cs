...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getPaymentsCreate operation.
    /// </summary>
    public partial class GetPaymentsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetPaymentsCreateHeaders class.
        /// </summary>
        public GetPaymentsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetPaymentsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
