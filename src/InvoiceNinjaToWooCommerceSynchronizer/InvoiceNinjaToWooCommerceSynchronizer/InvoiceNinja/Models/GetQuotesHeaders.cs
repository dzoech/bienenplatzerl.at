...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getQuotes operation.
    /// </summary>
    public partial class GetQuotesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetQuotesHeaders class.
        /// </summary>
        public GetQuotesHeaders()
        {
            CustomInit();
        }
        ...
        public GetQuotesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
