...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getRecurringInvoices operation.
    /// </summary>
    public partial class GetRecurringInvoicesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetRecurringInvoicesHeaders
        /// class.
        /// </summary>
        public GetRecurringInvoicesHeaders()
        {
            CustomInit();
        }
        ...
        public GetRecurringInvoicesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
