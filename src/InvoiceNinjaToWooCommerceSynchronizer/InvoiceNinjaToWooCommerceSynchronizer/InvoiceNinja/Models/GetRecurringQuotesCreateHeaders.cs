...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getRecurringQuotesCreate operation.
    /// </summary>
    public partial class GetRecurringQuotesCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetRecurringQuotesCreateHeaders
        /// class.
        /// </summary>
        public GetRecurringQuotesCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetRecurringQuotesCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
