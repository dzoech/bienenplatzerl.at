...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getRecurringQuotes operation.
    /// </summary>
    public partial class GetRecurringQuotesHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetRecurringQuotesHeaders class.
        /// </summary>
        public GetRecurringQuotesHeaders()
        {
            CustomInit();
        }
        ...
        public GetRecurringQuotesHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
