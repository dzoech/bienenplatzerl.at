...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getShowTemplate operation.
    /// </summary>
    public partial class GetShowTemplateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetShowTemplateHeaders class.
        /// </summary>
        public GetShowTemplateHeaders()
        {
            CustomInit();
        }
        ...
        public GetShowTemplateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
