...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getSubscriptionsCreate operation.
    /// </summary>
    public partial class GetSubscriptionsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetSubscriptionsCreateHeaders
        /// class.
        /// </summary>
        public GetSubscriptionsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetSubscriptionsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
