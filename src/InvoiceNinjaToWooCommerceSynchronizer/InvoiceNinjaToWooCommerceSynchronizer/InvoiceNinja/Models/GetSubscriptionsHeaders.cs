...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getSubscriptions operation.
    /// </summary>
    public partial class GetSubscriptionsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetSubscriptionsHeaders class.
        /// </summary>
        public GetSubscriptionsHeaders()
        {
            CustomInit();
        }
        ...
        public GetSubscriptionsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
