...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getUsersCreate operation.
    /// </summary>
    public partial class GetUsersCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetUsersCreateHeaders class.
        /// </summary>
        public GetUsersCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetUsersCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
