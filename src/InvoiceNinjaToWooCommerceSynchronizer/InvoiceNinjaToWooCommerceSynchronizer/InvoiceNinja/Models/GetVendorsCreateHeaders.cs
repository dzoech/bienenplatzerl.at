...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getVendorsCreate operation.
    /// </summary>
    public partial class GetVendorsCreateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVendorsCreateHeaders class.
        /// </summary>
        public GetVendorsCreateHeaders()
        {
            CustomInit();
        }
        ...
        public GetVendorsCreateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
