...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for getVendors operation.
    /// </summary>
    public partial class GetVendorsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the GetVendorsHeaders class.
        /// </summary>
        public GetVendorsHeaders()
        {
            CustomInit();
        }
        ...
        public GetVendorsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
