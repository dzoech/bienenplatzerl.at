...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for postPurgeCompany operation.
    /// </summary>
    public partial class PostPurgeCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the PostPurgeCompanyHeaders class.
        /// </summary>
        public PostPurgeCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public PostPurgeCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
