...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for postPurgeCompanySaveSettings operation.
    /// </summary>
    public partial class PostPurgeCompanySaveSettingsHeaders
    {
        /// <summary>
        /// Initializes a new instance of the
        /// PostPurgeCompanySaveSettingsHeaders class.
        /// </summary>
        public PostPurgeCompanySaveSettingsHeaders()
        {
            CustomInit();
        }
        ...
        public PostPurgeCompanySaveSettingsHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
