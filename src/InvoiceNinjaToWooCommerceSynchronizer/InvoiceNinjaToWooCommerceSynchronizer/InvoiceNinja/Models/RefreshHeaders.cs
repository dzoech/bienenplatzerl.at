...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for refresh operation.
    /// </summary>
    public partial class RefreshHeaders
    {
        /// <summary>
        /// Initializes a new instance of the RefreshHeaders class.
        /// </summary>
        ...
        public RefreshHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
