...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showClient operation.
    /// </summary>
    public partial class ShowClientHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowClientHeaders class.
        /// </summary>
        public ShowClientHeaders()
        {
            CustomInit();
        }
        ...
        public ShowClientHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
