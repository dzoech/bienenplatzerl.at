...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showCompanyGateway operation.
    /// </summary>
    public partial class ShowCompanyGatewayHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowCompanyGatewayHeaders class.
        /// </summary>
        public ShowCompanyGatewayHeaders()
        {
            CustomInit();
        }
        ...
        public ShowCompanyGatewayHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
