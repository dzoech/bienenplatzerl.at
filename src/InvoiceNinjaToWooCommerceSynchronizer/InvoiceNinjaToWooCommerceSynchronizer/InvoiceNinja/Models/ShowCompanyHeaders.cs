...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showCompany operation.
    /// </summary>
    public partial class ShowCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowCompanyHeaders class.
        /// </summary>
        public ShowCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public ShowCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
