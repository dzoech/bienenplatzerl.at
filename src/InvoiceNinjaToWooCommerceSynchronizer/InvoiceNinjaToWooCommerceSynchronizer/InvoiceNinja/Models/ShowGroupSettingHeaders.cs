...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showGroupSetting operation.
    /// </summary>
    public partial class ShowGroupSettingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowGroupSettingHeaders class.
        /// </summary>
        public ShowGroupSettingHeaders()
        {
            CustomInit();
        }
        ...
        public ShowGroupSettingHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
