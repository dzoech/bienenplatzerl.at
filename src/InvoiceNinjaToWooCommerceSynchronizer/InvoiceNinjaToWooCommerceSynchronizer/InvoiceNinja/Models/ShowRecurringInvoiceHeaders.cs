...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showRecurringInvoice operation.
    /// </summary>
    public partial class ShowRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public ShowRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public ShowRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
