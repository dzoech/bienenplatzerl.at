...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showRecurringQuote operation.
    /// </summary>
    public partial class ShowRecurringQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowRecurringQuoteHeaders class.
        /// </summary>
        public ShowRecurringQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public ShowRecurringQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
