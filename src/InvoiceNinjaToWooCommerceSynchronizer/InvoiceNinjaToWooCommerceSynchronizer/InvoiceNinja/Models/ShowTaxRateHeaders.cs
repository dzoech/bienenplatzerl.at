...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showTaxRate operation.
    /// </summary>
    public partial class ShowTaxRateHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowTaxRateHeaders class.
        /// </summary>
        public ShowTaxRateHeaders()
        {
            CustomInit();
        }
        ...
        public ShowTaxRateHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
