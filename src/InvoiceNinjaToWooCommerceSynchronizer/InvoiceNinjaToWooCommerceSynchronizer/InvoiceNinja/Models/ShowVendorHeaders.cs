...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for showVendor operation.
    /// </summary>
    public partial class ShowVendorHeaders
    {
        /// <summary>
        /// Initializes a new instance of the ShowVendorHeaders class.
        /// </summary>
        public ShowVendorHeaders()
        {
            CustomInit();
        }
        ...
        public ShowVendorHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
