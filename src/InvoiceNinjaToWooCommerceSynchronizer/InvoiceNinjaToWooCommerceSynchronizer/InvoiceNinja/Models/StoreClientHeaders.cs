...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeClient operation.
    /// </summary>
    public partial class StoreClientHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreClientHeaders class.
        /// </summary>
        public StoreClientHeaders()
        {
            CustomInit();
        }
        ...
        public StoreClientHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
