...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeCredit operation.
    /// </summary>
    public partial class StoreCreditHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreCreditHeaders class.
        /// </summary>
        public StoreCreditHeaders()
        {
            CustomInit();
        }
        ...
        public StoreCreditHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
