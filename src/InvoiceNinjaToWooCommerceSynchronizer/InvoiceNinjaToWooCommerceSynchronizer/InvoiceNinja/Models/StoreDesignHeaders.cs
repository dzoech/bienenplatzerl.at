...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeDesign operation.
    /// </summary>
    public partial class StoreDesignHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreDesignHeaders class.
        /// </summary>
        public StoreDesignHeaders()
        {
            CustomInit();
        }
        ...
        public StoreDesignHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
