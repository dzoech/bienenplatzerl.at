...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeGroupSetting operation.
    /// </summary>
    public partial class StoreGroupSettingHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreGroupSettingHeaders class.
        /// </summary>
        public StoreGroupSettingHeaders()
        {
            CustomInit();
        }
        ...
        public StoreGroupSettingHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
