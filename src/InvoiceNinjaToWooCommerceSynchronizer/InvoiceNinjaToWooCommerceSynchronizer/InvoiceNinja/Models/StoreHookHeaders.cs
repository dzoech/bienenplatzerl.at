...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeHook operation.
    /// </summary>
    public partial class StoreHookHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreHookHeaders class.
        /// </summary>
        public StoreHookHeaders()
        {
            CustomInit();
        }
        ...
        public StoreHookHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
