...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeInvoice operation.
    /// </summary>
    public partial class StoreInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreInvoiceHeaders class.
        /// </summary>
        public StoreInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public StoreInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
