...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storePayment operation.
    /// </summary>
    public partial class StorePaymentHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StorePaymentHeaders class.
        /// </summary>
        public StorePaymentHeaders()
        {
            CustomInit();
        }
        ...
        public StorePaymentHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
