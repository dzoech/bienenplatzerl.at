...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeProduct operation.
    /// </summary>
    public partial class StoreProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreProductHeaders class.
        /// </summary>
        public StoreProductHeaders()
        {
            CustomInit();
        }
        ...
        public StoreProductHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
