...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeQuote operation.
    /// </summary>
    public partial class StoreQuoteHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreQuoteHeaders class.
        /// </summary>
        public StoreQuoteHeaders()
        {
            CustomInit();
        }
        ...
        public StoreQuoteHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
