...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for storeRefund operation.
    /// </summary>
    public partial class StoreRefundHeaders
    {
        /// <summary>
        /// Initializes a new instance of the StoreRefundHeaders class.
        /// </summary>
        public StoreRefundHeaders()
        {
            CustomInit();
        }
        ...
        public StoreRefundHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
