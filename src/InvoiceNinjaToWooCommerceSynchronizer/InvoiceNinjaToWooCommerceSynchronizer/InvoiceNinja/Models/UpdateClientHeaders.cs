...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateClient operation.
    /// </summary>
    public partial class UpdateClientHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateClientHeaders class.
        /// </summary>
        public UpdateClientHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateClientHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
