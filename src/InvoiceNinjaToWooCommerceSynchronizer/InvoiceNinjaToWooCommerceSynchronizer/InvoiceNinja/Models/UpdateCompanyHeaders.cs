...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateCompany operation.
    /// </summary>
    public partial class UpdateCompanyHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateCompanyHeaders class.
        /// </summary>
        public UpdateCompanyHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateCompanyHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
