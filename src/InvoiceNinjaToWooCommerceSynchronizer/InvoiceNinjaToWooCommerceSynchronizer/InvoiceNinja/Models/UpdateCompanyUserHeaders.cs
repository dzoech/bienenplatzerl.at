...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateCompanyUser operation.
    /// </summary>
    public partial class UpdateCompanyUserHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateCompanyUserHeaders class.
        /// </summary>
        public UpdateCompanyUserHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateCompanyUserHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
