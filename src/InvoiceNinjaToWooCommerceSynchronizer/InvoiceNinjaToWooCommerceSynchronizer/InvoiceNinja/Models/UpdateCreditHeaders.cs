...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateCredit operation.
    /// </summary>
    public partial class UpdateCreditHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateCreditHeaders class.
        /// </summary>
        public UpdateCreditHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateCreditHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
