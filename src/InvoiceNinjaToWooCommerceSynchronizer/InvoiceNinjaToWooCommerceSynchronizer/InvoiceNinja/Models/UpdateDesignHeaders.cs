...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateDesign operation.
    /// </summary>
    public partial class UpdateDesignHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateDesignHeaders class.
        /// </summary>
        public UpdateDesignHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateDesignHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
