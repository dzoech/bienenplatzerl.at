...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateExpense operation.
    /// </summary>
    public partial class UpdateExpenseHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateExpenseHeaders class.
        /// </summary>
        public UpdateExpenseHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateExpenseHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
