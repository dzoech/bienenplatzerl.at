...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateInvoice operation.
    /// </summary>
    public partial class UpdateInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateInvoiceHeaders class.
        /// </summary>
        public UpdateInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
