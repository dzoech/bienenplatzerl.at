...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateProduct operation.
    /// </summary>
    public partial class UpdateProductHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateProductHeaders class.
        /// </summary>
        public UpdateProductHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateProductHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
