...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateRecurringInvoice operation.
    /// </summary>
    public partial class UpdateRecurringInvoiceHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateRecurringInvoiceHeaders
        /// class.
        /// </summary>
        public UpdateRecurringInvoiceHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateRecurringInvoiceHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
