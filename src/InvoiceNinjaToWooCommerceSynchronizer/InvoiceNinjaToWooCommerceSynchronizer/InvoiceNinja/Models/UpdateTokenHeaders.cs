...
namespace InvoiceNinjaClient.Models
{
    ...
    /// <summary>
    /// Defines headers for updateToken operation.
    /// </summary>
    public partial class UpdateTokenHeaders
    {
        /// <summary>
        /// Initializes a new instance of the UpdateTokenHeaders class.
        /// </summary>
        public UpdateTokenHeaders()
        {
            CustomInit();
        }
        ...
        public UpdateTokenHeaders(double? xAPIVersion = default(double?), int? xRateLimitRemaining = default(int?), int? xRateLimitLimit = default(int?))
        {
